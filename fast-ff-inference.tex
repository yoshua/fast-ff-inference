...
given by~\citet{Urbanczik+Senn-2014}. However, Eq.~\ref{eq:delta-W}
does not take into account the contribution of $W_{b,i,j}$ on $C_{b,i}$
via the value of $s_j$ at the fixed point and future work should
investigate how to take that into account.
